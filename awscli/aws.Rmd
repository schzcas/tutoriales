...
que provee más servicios, pero pueden escoger el que quieran.Para más información de los servidores 
...
S3 es el el servicio de cloud storage de nuestro muchacho el pelon-pellorico de Jeff Bezos.
Si quieren nerdear, entrar al siguiente link, hay un videito bien cagado:
[Amazon S3](https://aws.amazon.com/s3/)

Entramos en la consola desde tu browser favorito... (Internet Explorer...not]) (Se puede hacer desde la terminal, pero eeeeehh).
[AWS Management Console](https://aws.amazon.com/console/)

1. Logearte en tu consola de AWS - [AWS Management Console](https://aws.amazon.com/console/)

2. Dar click en el iconito S3 de color rojo abajo de donde dice "Storage & Content Delivery, primera columna"
3. Dar click en "Create a Bucket"
4. Pongan el nombre de su proyecto. Lo culero es que cada bucket es unico y solo pueden poner un nombre que nadie más haya usado en el mundo... de la verga no?

... sharan!!!
Ya tienen su bucket. 

Ya estando aquí denle click a la carpeta y en "Actions" pueden subir sus bases de datos. -> como por ejemplo la de los ovnis que vimos en clase.
...
```
AJAAA!!!
Les va a dar error, porque todavía no hemos ligado nuestra compu a la "nube" del señor Bezos.
